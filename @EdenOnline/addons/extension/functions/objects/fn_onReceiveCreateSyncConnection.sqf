...
// Snapshot and live callbacks can overlap. Treat an already-present
// connection as a successful idempotent create instead of a sync failure.
if (EOEX_var_SyncConnectionKeys getOrDefault [_connectionKey, false]) exitWith { true };
