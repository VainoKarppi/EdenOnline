...
public class ArmaObject
{
    ...
    public ArmaObject(string id, string classname, object[] position, object[] rotation, string? parentId = null, string? groupId = null, Dictionary<string, object?>? metadata = null)
    {
        Id = id;
        Classname = classname;
        Position = position;
